...
class _AddTransactionPageContentState extends State<_AddTransactionPageContent>
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      title: _isExpense ? 'New Expense' : 'New Income',
      useScrollView: true,
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(
                      color:
                          themeExt.onSurfaceVariant.withValues(alpha: 0.3),
                    ),
                    prefixIcon: Padding(
                      padding:
                    ...
                    border: UnderlineInputBorder(
                      borderSide:
                          BorderSide(color: themeExt.outlineVariant),
                    ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: themeExt.outlineVariant),
                    ),
                    child: Row(
                      children: [
                        Container(
